...
paperweight {
    serverProject.set(project(":bubble-server"))
    ...
    useStandardUpstream("pufferfish") {
        ...
        withStandardPatcher {
            ...
            apiPatchDir.set(layout.projectDirectory.dir("patches/bukkit"))
            serverPatchDir.set(layout.projectDirectory.dir("patches/server"))

            apiOutputDir.set(layout.projectDirectory.dir("bubble-api"))
            serverOutputDir.set(layout.projectDirectory.dir("bubble-server"))
        }
    }
}